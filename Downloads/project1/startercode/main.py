...
class Plan:
    ...
    def stack(self, block1, block2):
        # if block2 is clear safe to stack

        if block2.air and block1.clear:
            block2.air = False
            block2.on = None
            block1.clear = False
            block2.on = block1
            ...
            # block2 should be on air
            # block2 should not have something on top of it
            # set block2 to clear (because block1 is in air)
            ##block2.clear = True
            #block2.air = False
            #block2.on = None

            #block1.unclear = False
    ...
    ##def heuristic(): ##number of blocks that are currently not in the right position which the goal
